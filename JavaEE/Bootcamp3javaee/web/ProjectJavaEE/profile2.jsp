    ...
    <div class="row">
        <div class="col-lg-8">
            <article>
                ...
                <section class="mb-5" style="background-color: rgba(255,250,250, 0.6)">
                    <%
...
<%--            <div class="container  py-5" >--%>
                <div class="row d-flex justify-content-center" >
                    Добавь интересное в blog post
<%--                    <div class="col-md-12 col-lg-10 col-xl-8">--%>
                        <div class="card" style="background-color: rgba(255,250,250, 0.1)">
                            <div class="card-body">
            <form action="/addNews" method="post">
                <div class="card-footer py-3 border-0" style="background-color: rgba(135,206,250, 0.5)" >
                    <div class="d-flex flex-start w-100">
                        <div class="form-outline w-100">
                            <textarea class="form-control" id="textAreaExample" rows="2" name="title" style="background: #fff;" placeholder="Title..." ></textarea>
                            <br>
                            <textarea class="form-control" id="textAreaExample2" rows="4" name="content" style="background: #fff;" placeholder="Content..." ></textarea>
